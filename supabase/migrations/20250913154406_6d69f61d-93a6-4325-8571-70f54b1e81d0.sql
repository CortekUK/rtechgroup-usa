-- Create missing unique constraints if they don't exist
...
BEGIN
  ...
  -- Insert ledger payment entry (idempotent using correct constraint)
  ...
  -- Insert P&L revenue entry (idempotent using correct constraint)
