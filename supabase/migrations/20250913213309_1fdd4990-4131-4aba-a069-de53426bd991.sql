...
DROP POLICY IF EXISTS "Allow all operations for app users" ON public.customers;
...
DROP POLICY IF EXISTS "Allow all operations for app users" ON public.pnl_entries;
...
DROP POLICY IF EXISTS "Allow all operations for app users" ON public.payment_applications;
