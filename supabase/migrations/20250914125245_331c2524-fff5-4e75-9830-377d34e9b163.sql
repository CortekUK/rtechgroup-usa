...
DROP POLICY IF EXISTS "Enable all operations for insurance_policies" ON insurance_policies;
...
DROP POLICY IF EXISTS "Enable all operations for insurance_documents" ON insurance_documents;
